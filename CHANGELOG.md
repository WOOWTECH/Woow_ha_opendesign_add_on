...
- Serialize browser-bridge and renderer Chromium acceptance on small CI runners: deterministic binary stubs verify the bridge first, then real image/PDF/PPTX endpoints run after the browser exits.
