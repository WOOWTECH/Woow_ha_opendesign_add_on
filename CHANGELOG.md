...
- Serialize browser-bridge and renderer Chromium acceptance on small CI runners: deterministic binary stubs verify the bridge first, wait for Chromium/crashpad cleanup, then run real image/PDF/PPTX endpoints.
